...
function UserProfile() {
  return (
    <div className="user-profile" bg-gray-100 md:p-8 sm:p-4 max-w-sm mx-auto my-20 rounded-lg shadow-lg sm:text-sm md:text-base sm:w-24 md:w-36 md:h-36 max-w-xs md:max-w-sm text-lg md:text-xl sm:h-24>
